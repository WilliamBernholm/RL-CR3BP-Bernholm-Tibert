...
# Validation rerun: THE honest 5-point success definition (single source of truth).
...
def save_eval_episode_archive_npz_json(
    ...
    # Validation rerun: the honest 5-point ("true") success, computed from the
    # latched env success flag + terminal reason. This is the robust key that
    # makes TLI success derivable directly and correctly from the npz (the old
    # loose ballistic_tli_corridor_hit inflated TLI success ~5-6x).
    true_success_5pt = bool(episode_success({
    ...
    save_dict = {
        "true_success_5pt": np.asarray([int(true_success_5pt)], dtype=np.int64),
        "traj_rot_full": traj,
    ...
    meta = {
        ...
        "true_success_5pt": bool(true_success_5pt),
